    ...
    render() {
        ...
        if (completed) {
            return ( <
                ...
                a href = {
                    `https://twitter.com/intent/tweet?text=My typing speed is ${wpm}. Let's see how fast you are! 😃 - created by @florinpop1705 https://codepen.io/FlorinPop17/full/ExxYJdE`
                }
                target = '_blank'
                className = 'share' >
                Twitter <
